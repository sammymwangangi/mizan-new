    ...
    <section className="relative w-full overflow-hidden bg-[radial-gradient(circle_at_50%_8%,rgba(255,255,255,0.98),rgba(255,255,255,0.72)_22%,transparent_42%),linear-gradient(112deg,#f9e0ff_0%,#ffffff_50%,#dcd7ff_100%)] px-5 pb-14 pt-16 sm:px-8 md:pb-18 md:pt-20 lg:px-12 lg:pb-20">
      <div className="mx-auto max-w-[1360px]">
        ...
        <div className="mx-auto mt-4 flex max-w-[760px] flex-col items-center gap-6 text-center">
          <h2 className="bg-[linear-gradient(180deg,#280137_34%,#8a609f_109%)] bg-clip-text text-[64px] font-extrabold leading-[1.08] text-transparent">
        ...
        <div className="mt-8 grid grid-cols-1 items-end gap-5 lg:grid-cols-[1fr_1fr_1fr] lg:gap-4 xl:gap-6">
          <article className="relative flex min-h-[420px] flex-col rounded-[30px] bg-white/88 p-8 shadow-[0_24px_80px_rgba(80,36,132,0.10)] ring-1 ring-black/[0.03] sm:min-h-[480px] sm:p-11 lg:min-h-[516px]">
            ...
            <h3 className="mt-8 max-w-[330px] text-[40px] font-medium leading-[1.1] tracking-[-0.01em] text-black">
              Get paid
              <br />
              <span className="text-[#8f00e0] text-[52px] font-semibold">3 x faster</span>
            </h3>
          ...
          <article className="relative flex h-[482px] flex-col rounded-[30px] bg-white/92 p-6 shadow-[0_24px_80px_rgba(80,36,132,0.10)] ring-1 ring-black/[0.03]">
            ...
            <div className="relative mt-8 max-w-[262px]">
              ...
              <div className="relative ml-5 rounded-[34px] bg-white/86 px-2 py-4 text-center shadow-[0_16px_40px_rgba(91,45,132,0.08)] ring-[10px] ring-white rotate-[3deg]">
                <p className="text-[14px] text-black">You saved</p>
                <p className="mt-4 text-[24px] font-normal leading-none text-[#313131]">
                  $ <span className="font-semibold text-[#6F4DFB]">450.00</span>{" "}
                  <span className="text-[22px] text-[#313131]">USD</span>
                </p>
